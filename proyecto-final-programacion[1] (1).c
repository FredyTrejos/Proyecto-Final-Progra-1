...
#define LIMPIARPANTALLLA() system("cls"); // limpiar la pantalla
#define ENTERS printf("\nPresione Enter para salir...");getchar();getchar();// confirmacion de salida
...
Compra crearCompra(Libro libros[], Cliente clientes[]){
	...
	// printf("Total a pagar: $%.2f", compra.totalAPagar);
